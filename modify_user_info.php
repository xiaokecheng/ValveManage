		...
		<div class="m-right">
			...
			<div class="main">
				...
				<form class="add_admin_form">
					<div class="modify">
						<span>用户ID:</span><input  type="text" placeholder="" name="yonghuming" value="<?php echo $userid_format?>" readonly="readonly" class="am-form-field">
						<span>用户名:</span><input  type="text" placeholder="" name="yonghuming" value="<?php echo $username?>" readonly="readonly" class="am-form-field">
						<span>email:</span><input  type="text" placeholder="" name="email" value="<?php echo $email?>">
						<span>电话:</span><input  type="text" placeholder="" name="dianhua" value="<?php echo $telephone?>">
					</div>

					<div class="save_modify">
					<button id="login-button" onclick="checkuserinfo()">修改</button>
					</div>
