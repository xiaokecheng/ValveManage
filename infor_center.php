	...
	<div class="left_menu">
	  <ul id="nav_dot">
       <li>
		...
		<li>
          <h4 class="M4" style="background-color: #0075B0;"><span></span><a href="infor_center.php">消息中心</a></h4>
        </li>
	   ...
	   <div class="main">	
	   		<div class="info-center-title">
				...
				<span class="padding-large-right pull-left">
					<a id="read" href="#">已读消息(
						<span style="color: #0e90d2;">1</span>
						)</a>
				</span>
				
				<span class="pull-left">
					<a id="unread" href="#">未读消息(
						<span style="color: #0e90d2;">0</span>
						)</a>
				</span>
	   		</div>
            				...
            				<td>
            				 	<div class="am-btn-toolbar">
                   					 <div class="am-btn-group am-btn-group-xs">
                      						<button class="am-btn am-btn-default am-btn-xs am-text-secondary" style="margin-right: 5px;">标为已读</button>
                      						<button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">删除</button>
                                	 </div>
                 				 </div>
            				</td>
            				<td></td>
